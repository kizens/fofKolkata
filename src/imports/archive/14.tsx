...
export default function Component() {
  return (
    <div className="bg-black overflow-clip relative rounded-[60px] size-full" data-name="14">
      ...
      <div className="-translate-y-1/2 absolute h-[720px] left-[calc(25%+100px)] rounded-[32px] top-1/2 w-[1280px]" data-name="Research 1">
        <video autoPlay className="absolute max-w-none object-cover rounded-[32px] size-full" controlsList="nodownload" playsInline>
          <source src="/_videos/v1/595ffd95c609dd772c8d6c18d3e04645a9b43968" />
        </video>
      </div>
      <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[12px] h-[422px] items-start left-[100px] not-italic text-white top-1/2 w-[415px]">
        <p className="font-['Bebas_Neue:Regular',sans-serif] leading-[60px] relative shrink-0 text-[60px] w-[415px]">Secondary researcH</p>
        <div className="font-['Work_Sans:Light',sans-serif] h-[350px] leading-[0] min-w-full relative shrink-0 text-[24px] w-[min-content]">
          <p className="leading-[36px] mb-0">Secondary research becomes a high-leverage step with Gemini.</p>
          <p className="leading-[36px]">It can scan articles, industry papers, user forums, market trends, and documentation, then summarize patterns, compare viewpoints, and highlight gaps — freeing designers to focus on interpretation, decisions, and next steps instead of raw information gathering.</p>
        </div>
      </div>
      <a className="absolute block font-['Work_Sans:Regular',sans-serif] font-normal h-[40px] leading-[0] left-[103px] text-[#5e5e5e] text-[20px] top-[980px] tracking-[-0.4px] w-[948px]" href="https://youtu.be/s_JUP2BSn4s?si=VS2-Bq0u5oXE3H9n&t=47">
